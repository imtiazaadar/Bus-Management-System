<?php
    ...
    if(isset($_POST['Submit'])){
        ...
        if($user_password == $user_con_password){
            $sql = "INSERT INTO ADMIN_INFO(NAME, EMAIL, PHONE, PASSWORD) VALUES('$user_name', '$user_email', $user_phone, '$user_password')";
...
<body>
    ...
    <form method="post">
        ...
        <input class="user-submit" type="submit" name="Submit" value="SUBMIT"> <br>
    </form>
    <style>
        body{
            padding: 20px;
