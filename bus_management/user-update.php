...
<?php
    include 'connect.php';
    $phone_ = $_GET['updatephone'];
    if(isset($_POST['Update'])){
        $name_ = $_POST['Name'];
        $email_ = $_POST['Email'];
        $pass_ = $_POST['Password'];
        $sql = "UPDATE USER_INFO SET NAME = '$name_', EMAIL = '$email_', PHONE = '$phone_', PASSWORD = '$pass_' WHERE PHONE = '$phone_'";
...
<h1>USER UPDATE</h1>
    <form method="post">
        ...
        <a class="back" href="manage-account.php"><i class="fas fa-chevron-circle-left"></i></a>
